...
INSERT INTO users (
  ...
  (6, 1, 'Anna', 'Conti', 'dipendente1@fusarouomo.com',
   '$2a$10$e/ULie.9SQf5MIQSNjkxEO7.xAyc6zv/qysVTE4mVFhZum/BjT5VG',
   'employee', 1, 4,
   'Cassa', '2026-03-05', NULL, 'full_time', 40,
   'active', 'ACME-001',
  ...
  (7, 1, 'Roberto', 'Mancini', 'dipendente2@fusarouomo.com',
   '$2a$10$e/ULie.9SQf5MIQSNjkxEO7.xAyc6zv/qysVTE4mVFhZum/BjT5VG',
   'employee', 1, 4,
   'Magazzino', '2026-01-15', '2026-12-31', 'part_time', 20,
   'active', 'ACME-002',
  ...
  (8, 1, 'Chiara', 'Lombardi', 'dipendente3@fusarouomo.com',
   '$2a$10$e/ULie.9SQf5MIQSNjkxEO7.xAyc6zv/qysVTE4mVFhZum/BjT5VG',
   'employee', 2, 5,
   'Cassa', '2025-11-20', NULL, 'full_time', 40,
   'active', 'ACME-003',
...
INSERT INTO users (
  ...
  (12, 2, 'Carol', 'Russo', 'carol@beta.com',
   '$2a$10$e/ULie.9SQf5MIQSNjkxEO7.xAyc6zv/qysVTE4mVFhZum/BjT5VG',
   'employee', 3, 11,
   'Vendite', '2026-03-10', NULL, 'full_time', 40,
   'active', 'BETA-001',
  ...
  (13, 2, 'Marco', 'Bruno', 'marco@beta.com',
   '$2a$10$e/ULie.9SQf5MIQSNjkxEO7.xAyc6zv/qysVTE4mVFhZum/BjT5VG',
   'employee', 3, 11,
   'Cassa', '2025-12-05', '2026-09-30', 'part_time', 24,
   'active', 'BETA-002',
